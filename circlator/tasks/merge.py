...
def run():
    ...
    parser.add_argument('--min_spades_circ_pc', type=float, help='Min % of contigs needed to be covered by nucmer hits to spades circular contigs', metavar='FLOAT', default=95)
